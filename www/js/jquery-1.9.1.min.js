...
function yalnizSayi(evt) {
	var charCode = (evt.which) ? evt.which : event.keyCode

	var valkilo = $("#kilo").val().replace(/[^0-9\.]+/g, ''),
		valboy = $("#boy").val().replace(/[^0-9\.]+/g, '');
	if (charCode == 13) {
...
function hesapla() {
    ...
    if (sonuc <= 18.4) {
    	$("#bilgi").addClass("azureBG").addClass("black");
    	$("#sonuc").text("Zayıf");
    	...
    	$("#bilgi").addClass("aquamarineBG").addClass("black");
    	$("#sonuc").removeClass().addClass("greenC");
        $("#sonuc").text("Normal");
    	...
    	$("#bilgi").addClass("greenBG").addClass("white");
    	...
    	$("#bilgi").addClass("orangeBG").addClass("black");
        $("#sonuc").text("Şişman");
        $("#bilgi").text("30.0 - 34.9: Boyunuza göre vücut ağırlığınızın fazla olduğunun, bir başka deyişle şişman olduğunuzun bir göstergesidir. Şişmanlık, kalp-damar hastalıkları, diyabet, hipertansiyon v.b. kronik hastalıklar için risk faktörüdür. Bir sağlık kuruluşuna başvurarak hekim / diyetisyen kontrolünde zayıflayarak normal ağırlığa inmeniz sağlığınız açısından çok önemlidir. Lütfen, sağlık kuruluşuna başvurunuz.");
    }
    else if (sonuc >= 35.0 && sonuc <= 44.9) {
    	$("#bilgi").addClass("orangeredBG").addClass("white");
        $("#sonuc").text("Aşırı şişman");
        $("#bilgi").text("35.0 - 44.9: Boyunuza göre vücut ağırlığınızın fazla olduğunun, bir başka deyişle şişman olduğunuzun bir göstergesidir. Şişmanlık, kalp-damar hastalıkları, diyabet, hipertansiyon v.b. kronik hastalıklar için risk faktörüdür. Bir sağlık kuruluşuna başvurarak hekim / diyetisyen kontrolünde zayıflayarak normal ağırlığa inmeniz sağlığınız açısından çok önemlidir. Lütfen, sağlık kuruluşuna başvurunuz.");
    }
    else if (sonuc >= 45.0) {
    	$("#bilgi").addClass("redBG").addClass("white");
        $("#sonuc").text("Morbid (ölümcül) şişman");
